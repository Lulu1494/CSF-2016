...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // multiplies the window and graphics size
    ...
    public static void setCanvasSize(int canvasWidth, int canvasHeight, double zoom) {
        StdDraw.zoom = zoom;
    ...
    private static void init() {
        ...
        onscreenImage  = new BufferedImage((int) (width * zoom), (int) (height * zoom), BufferedImage.TYPE_INT_ARGB);
    ...
    ***************************************************************************/
    ...
    private static void draw() {
        if (defer) return;
        onscreen.drawImage(offscreenImage, 0, 0, (int) (width * zoom), (int) (height * zoom), null);
        frame.repaint();
    }
