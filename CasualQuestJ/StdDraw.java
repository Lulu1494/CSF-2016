...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static void setPenColor(double r, double g, double b) {
        if (r>=1) r=.999;
        if (r<0) r=0;
        if (g>=1) g=.999;
        if (g<0) g=0;
        ...
        setPenColor(new Color((int)(r*256),(int)(g*256),(int)(b*256)));
    }
    ...
    private static Image getImage(String filename) {
        if(iconCache != null && iconCache.containsKey(filename)) return iconCache.get(filename);
        ...
        if(iconCache != null) iconCache.put(filename, image);
        return image;
    }
...
//        int ws = metrics.stringWidth(s);
    ...
    public static HashSet<Integer> getKeysDown() { return keysDown; }
